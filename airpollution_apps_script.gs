 ...
 * รองรับ query param ?page=xxx สำหรับ serve หน้าอื่นในโปรเจกต์เดียวกัน เช่น ?page=stat2
 *
 ...
 * 'stat2' อยู่ในไฟล์นี้ที่เดียว — เป็นเพียงการ "เพิ่ม" บรรทัดแมปหน้า ไม่ได้แตะ
 * ตรรกะการรับ/บันทึกแบบสอบถามใด ๆ ทั้งสิ้น ฟังก์ชันคำนวณสถิติจริงทั้งหมดอยู่ใน
 * ไฟล์ stat2.gs แยกต่างหาก
 */
function doGet(e) {
  const pageMap = {
